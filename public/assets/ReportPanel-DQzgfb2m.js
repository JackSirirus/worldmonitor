var m=Object.defineProperty;var u=(n,e,t)=>e in n?m(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var a=(n,e,t)=>u(n,typeof e!="symbol"?e+"":e,t);import{t as d,e as p}from"./index-BSfUVQaD.js";import{u as v}from"./uiStore-XcXtLltv.js";import"./d3-CuXdqget.js";import"./topojson-BwRznoQ3.js";class L{constructor(e){a(this,"container");a(this,"element");a(this,"store",v);this.container=e,this.element=this.createElement(),this.render(),this.bindEvents()}createElement(){const e=document.createElement("div");return e.id="report-panel",e.className="report-panel",e}getElement(){return this.element}render(){const e=this.store.getState(),t=this.renderReports(e.reports),s=e.isGenerating;this.element.innerHTML=`
