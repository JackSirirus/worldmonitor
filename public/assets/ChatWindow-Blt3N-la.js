var c=Object.defineProperty;var o=(n,e,t)=>e in n?c(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var r=(n,e,t)=>o(n,typeof e!="symbol"?e+"":e,t);import{t as i,e as l}from"./index-BcbvXwFx.js";import{a as d}from"./uiStore-DD9v_Gzx.js";import"./d3-CuXdqget.js";import"./topojson-BwRznoQ3.js";class v{constructor(e){r(this,"container");r(this,"element");r(this,"store",d);this.container=e,this.element=this.createElement(),this.render(),this.bindEvents()}createElement(){const e=document.createElement("div");return e.id="chat-window",e.className="chat-window",e}getElement(){return this.element}render(){const e=this.store.getState(),t=e.messages.map(a=>this.renderMessage(a)).join("");this.element.innerHTML=`
